// Fractional Converter page
import { FractionConverter } from '../FractionConverter.js';

let calc = new FractionConverter();

export function loadFractionalConverter() {
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-header">
                        <h1><i class="fas fa-divide"></i> Fractional Converter</h1>
                        <p class="lead">Converter of fractional numbers between different number formats</p>
                    </div>
                    
                    <div class="alert alert-info">
                        <h5><i class="fas fa-info-circle"></i> How it works:</h5>
                        <p>This page converts number representations between binary, decimal, octal, hexadecimal numbers in any direction</p>
                        <p><strong>You can input using ',' or '.' as decimal separator, results are shown using ',' as decimal separator</strong></p>
                    </div>
                </div>
            </div>
                            ...
                            <form id="converterForm">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="inputNumber" class="form-control" placeholder="Enter a fractional number" />
